...
const Footer = () => {
    return (
        <footer className='bg-[#001931] px-6 sm:px-10 py-6 text-white mt-15'>
            <section className='flex flex-col md:flex-row md:justify-between md:items-start gap-10 border-b border-gray-600 pb-4 text-center md:text-left'>
              ...
              <div className=''>
                ...
                <div className='max-w-72 mx-auto md:mx-0 mt-5'>
                    <p className='text-gray-400 text-xs leading-5'>
                        An innovative Apps Store offering a wide range of applications for productivity, entertainment, and daily use. Discover, install, and manage your favorite apps easily with a smooth, fast, and user-friendly experience.
                    </p>
                </div>
              </div>
            ...
            <p className='text-center text-sm pt-7 mb-2 opacity-70'>
                Copyright © 2025 - All right reserved by M.S Mursalin
            </p>
        </footer>
    );
};
